...
<!-- Menu CSS -->
<link
	href='<c:url value="template/plugins/bower_components/sidebar-nav/dist/sidebar-nav.min.css" />'
	rel="stylesheet">
...
<!-- color CSS -->
<link href='<c:url value="template/css/colors/blue-dark.css" />'
	rel="stylesheet">
...
<!-- Preloader -->
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <form class="form-horizontal form-material" action='<c:url value="/project-add" />' method="post">
                                <div class="form-group">
                                    <label class="col-md-12">Tên dự án</label>
                                    <div class="col-md-12">
                                        <input type="text" placeholder="Tên công việc"
                                            class="form-control form-control-line" name="taskName"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Ngày bắt đầu</label>
                                    <div class="col-md-12">
                                        <input type="text" placeholder="dd/MM/yyyy"
                                            class="form-control form-control-line" name="taskStart"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Ngày kết thúc</label>
                                    <div class="col-md-12">
                                        <input type="text" placeholder="dd/MM/yyyy"
                                            class="form-control form-control-line" name="taskEnd"> </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-12">
	...
	<script
		src='<c:url value="template/plugins/bower_components/sidebar-nav/dist/sidebar-nav.min.js" />'></script>
